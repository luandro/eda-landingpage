...
const ExampleChat: React.FC<ExampleChatProps> = ({ className }) => (
  ...
  >
    ...
    >
      ...
      >
        <p className="text-base leading-relaxed">Como posso ajudar a proteger o meio ambiente?</p>
      </div>
    </motion.div>
    ...
    >
      ...
      >
        <p className="text-base leading-relaxed">
          ...
          <br /><br />
          • Reduzindo seu consumo de plástico<br />
          • Economizando água e energia<br />
          • Reciclando corretamente<br />
          • Apoiando iniciativas locais de conservação
        </p>
      </div>
    </motion.div>
  </div>
